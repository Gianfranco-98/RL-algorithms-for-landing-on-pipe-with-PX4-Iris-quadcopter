...
class DroneEnv(gym.Env):
    ...
    def __init__(self):
        ...
        high = np.array([
                         1.0,    # x drone pose - x des pose
                         0.5,    # y drone pose - y des pose
                         0.2,    # z drone pose - z des pose
                         0.1     # y drone velocity
                       ])
    ...
    def reset(self):
        ...
        y_vel = self.controller_object.getVelocity().y
        observation = [
                       x_dist, 
                       y_dist,
                       z_dist,
    ...
    def step(self, action):
        ...
        y_drone_velocity = observation[3]
